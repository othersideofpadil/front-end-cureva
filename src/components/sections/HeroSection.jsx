      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              {isAuthenticated ? (
                <Link
                  to="/bookings/new"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-linear-to-r from-sky-500 to-indigo-500 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-sky-500/25 transition-all"
                >
          ...
          >
            ...
            <div className="absolute -top-4 -right-4 w-72 h-72 bg-sky-200 rounded-full blur-3xl opacity-40"></div>
            <div className="absolute -bottom-4 -left-4 w-72 h-72 bg-indigo-200 rounded-full blur-3xl opacity-40"></div>
          </motion.div>
        </div>
      </div>
    </section>
